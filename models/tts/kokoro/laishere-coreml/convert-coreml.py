...
Vendored from https://github.com/laishere/kokoro-coreml (MIT) and adapted to
mobius CLI conventions (--output-dir).
...
Usage:
    PYTORCH_ENABLE_MPS_FALLBACK=1 uv run python convert-coreml.py \
        --output-dir build/laishere-kokoro [--max-frames 2000] [--stages all]
"""
import argparse
import math
import pathlib
