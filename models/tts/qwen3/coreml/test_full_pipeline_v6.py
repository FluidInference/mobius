# Full TTS Pipeline Test V6
# Uses V5 prefill + V2 decode (with trailing_text = tts_pad_embed)
import numpy as np
...
def test_full_pipeline():
    print("=" * 60)
    print("Full TTS Pipeline Test V6 (V5 Prefill + V2 Decode)")
    print("=" * 60)
    ...
    while len(generated_tokens) < MAX_CODEC_TOKENS:
        result = lm_decode.predict({
            ...
            "trailing_text_embed": tts_pad_embed,  # Use tts_pad as trailing text
            "kv_cache": current_kv,
    ...
    output_file = "test_full_pipeline_v6_output.wav"
