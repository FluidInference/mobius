"""Convert pinned Kev 0.5B weights to a fixed-shape FP16 Core ML program."""
...
def main() -> None:
    ...
    converted.short_description = (
        f"Kev 0.5B typed decision scoring, {shape.length} tokens, {shape.max_options} option slots"
    )
    ...
    path = args.output_dir / f"kev_0_5b_fp16_L{shape.length}_options{shape.max_options}.mlpackage"
