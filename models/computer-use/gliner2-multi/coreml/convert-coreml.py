"""Convert and verify the pinned GLiNER2.5-multi classification decision path."""
import argparse
import json
import math
...
def main():
    ...
    converted.short_description = "GLiNER2.5-multi native schema classification path"
    ...
    package = out / f"gliner2_multi_classification_{args.precision}_L{args.length}_K{args.max_options}.mlpackage"
