...
def main():
    ...
    parser.add_argument("--package", default="build/gliner2_multi_classification_fp16_L128_K8.mlpackage")
    ...
    source = Path.home() / ".cache/huggingface/hub/models--fastino--gliner2.5-multi-v1/snapshots" / MODEL_REVISION
