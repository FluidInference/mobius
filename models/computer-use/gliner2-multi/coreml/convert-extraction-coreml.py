"""Export the trained GLiNER2.5 multilingual boundary extraction stages to Core ML."""
...
def main():
    ...
    features_model.short_description = "GLiNER2.5 multilingual trained boundary extraction features"
    ...
    features_path = out / f"gliner2_multi_extraction_features_{suffix}.mlpackage"
    ...
    scorer_model.short_description = "GLiNER2.5 multilingual trained shared-pool extraction scorer"
    ...
    scorer_path = out / f"gliner2_multi_extraction_scorer_{suffix}.mlpackage"
