#!/usr/bin/env python3
"""Test the MASKED CoreML decoder with attention masking approach."""
...
print("="*70)
print("Test MASKED CoreML Decoder (Attention Masking Approach)")
print("="*70)
...
decoder = ct.models.MLModel("build/cohere_decoder_masked.mlpackage", compute_units=ct.ComputeUnit.CPU_AND_GPU)
print(f"   ✓ Loaded MASKED decoder with attention masking")
...
print("\n" + "="*70)
print("MASKED CoreML TEST COMPLETE")
print("="*70)
print("✅ If transcriptions are perfect with no repetitions, the masking fix works!")
print("🔍 Compare with ground truth to verify quality")
