#!/usr/bin/env python3
"""Test our encoder + BarathwajAnandan's reference decoder on LibriSpeech.

This verifies that our encoder export is correct by pairing it with the
known-working reference decoder.
"""
...
print("="*70)
print("Hybrid Test: Our Encoder + Reference Decoder")
print("="*70)
...
try:
    ...
    print(f"     Our encoder: build/cohere_encoder.mlpackage")
    print(f"     Reference decoder: barathwaj-models/cohere_decoder_cached.mlpackage")
except Exception as e:
...
print("SUMMARY")
print(f"{'='*70}")
print(f"Configuration: Our Encoder + Reference Decoder")
...
if avg_wer < 10:
    print("\n✅ ENCODER VERIFIED: Our encoder works perfectly!")
    print("   Issue is isolated to decoder export.")
else:
    print(f"\n⚠️  ENCODER ISSUE: {avg_wer:.2f}% WER suggests encoder problems")
    print("   Expected <10% WER with reference decoder.")
