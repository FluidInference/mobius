#!/usr/bin/env python3
"""Test full reference pipeline: Reference encoder + Reference decoder.

This establishes a baseline to verify BarathwajAnandan's models work correctly.
"""
...
print("="*70)
print("Full Reference Pipeline Test")
print("="*70)
...
try:
    ...
    print(f"   ✓ Reference models loaded")
    print(f"     Encoder: barathwaj-models/cohere_encoder.mlpackage")
    print(f"     Decoder: barathwaj-models/cohere_decoder_cached.mlpackage")
except Exception as e:
...
for sample_idx, sample in enumerate(samples):
    ...
    encoder_output = ref_encoder.predict({
...
print(f"\n{'='*70}")
print("SUMMARY - FULL REFERENCE PIPELINE")
print(f"{'='*70}")
print(f"Configuration: Reference Encoder + Reference Decoder")
...
if avg_wer < 10:
    print("\n✅ REFERENCE MODELS WORK: This is the expected baseline")
else:
    print(f"\n⚠️  REFERENCE MODELS BROKEN: {avg_wer:.2f}% WER")
    print("   BarathwajAnandan's models have the same issues!")
